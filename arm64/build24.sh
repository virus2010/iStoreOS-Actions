...
PACKAGES="$PACKAGES kmod-dwmac-rockchip"  # RK3566 以太网 MAC 驱动
PACKAGES="$PACKAGES kmod-fs-ext4"        # 核心文件系统
PACKAGES="$PACKAGES kmod-fs-vfat"        # 基础文件系统
...
PACKAGES="$PACKAGES kmod-phy-realtek"    # RTL8211F PHY 驱动 (重要)
...
PACKAGES="$PACKAGES dnsmasq-full" # 核心 DNS/DHCP 服务
PACKAGES="$PACKAGES firewall4"
PACKAGES="$PACKAGES fdisk"
PACKAGES="$PACKAGES grub2-efi-arm" # 用于启动
