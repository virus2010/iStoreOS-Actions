...
#PACKAGES="$PACKAGES bnx2x-firmware" #其他厂商固件
...
#PACKAGES="$PACKAGES containerd"  #Docker 核心组件
...
#PACKAGES="$PACKAGES docker" #Docker
##PACKAGES="$PACKAGES docker-compose" #Docker
PACKAGES="$PACKAGES dockerd" #Docker
...
#PACKAGES="$PACKAGES hostapd-common" # <--- [移除] Wi-Fi 基础组件
#PACKAGES="$PACKAGES hostapd-openssl" # <--- [移除] Wi-Fi 基础组件
...
#PACKAGES="$PACKAGES iw"  # <--- [移除] Wi-Fi 工具
#PACKAGES="$PACKAGES iwinfo" # <--- [移除] Wi-Fi 界面支持
...
#PACKAGES="$PACKAGES kmod-cfg80211"  # <--- [移除] Wi-Fi 基础
...
#PACKAGES="$PACKAGES kmod-mac80211" # <--- [移除] Wi-Fi 核心
...
#PACKAGES="$PACKAGES luci-lib-docker" # <--- [移除] Docker
...
#PACKAGES="$PACKAGES runc" # <--- [移除] Docker 核心组件
...
#PACKAGES="$PACKAGES tini" # <--- [移除] Docker 依赖
