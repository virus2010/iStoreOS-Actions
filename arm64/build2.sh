...
# iStoreOS官方集成列表，已移除 IPv6, Docker, MTK/无线网卡相关包
# 保留了基础系统、IPv4 网络、存储、LuCI 和您自定义的第三方包。
...
# REMOVED: containerd, docker, docker-compose, dockerd, tini (Docker)
...
# REMOVED: hostapd-common, hostapd-openssl (WiFi)
PACKAGES="$PACKAGES htop"
PACKAGES="$PACKAGES ip-full"
# REMOVED: ip6tables-nft (IPv6)
...
# REMOVED: iw, iwinfo, wireless-regdb, wpa-* (WiFi)
PACKAGES="$PACKAGES jansson4"
PACKAGES="$PACKAGES jshn"
PACKAGES="$PACKAGES jsonfilter"
PACKAGES="$PACKAGES kernel"
# **精简内核模块 (kmod-)**
# 保留基本的有线网卡、存储、文件系统和工具。
# REMOVED: 大部分 kmod-ath*, kmod-mt76*, kmod-rtlwifi*, kmod-rtw88*, kmod-rtw89*, kmod-brcmfmac (无线/WiFi)
# REMOVED: kmod-ip6-tunnel, kmod-ip6tables, kmod-ipsec6, kmod-iptunnel6, kmod-gre6, kmod-nf-*6, kmod-udptunnel6, kmod-nat46, kmod-siit, kmod-sit (IPv6)
# REMOVED: kmod-mhi-*, kmod-qrtr-* (部分 WWAN/QMI 依赖，如果不需要 WWAN 即可移除)
...
PACKAGES="$PACKAGES kmod-cfg80211" # 保留 cfg80211 作为内核网络基础
...
# REMOVED: kmod-mhi-bus, kmod-mhi-net, kmod-mhi-pci-generic, kmod-mhi-wwan-ctrl, kmod-mhi-wwan-mbim (WWAN)
...
# REMOVED: kmod-mt76*, kmod-mt79*, kmod-mtk-t7xx (MTK/WiFi)
PACKAGES="$PACKAGES kmod-mvneta"
PACKAGES="$PACKAGES kmod-mvpp2"
# REMOVED: kmod-mwifiex-pcie (WiFi)
# REMOVED: kmod-nat46 (IPv6)
...
# REMOVED: kmod-qrtr*, kmod-mhi-*, kmod-wwan (WWAN)
...
# REMOVED: kmod-rtl*, kmod-rtw* (无线/WiFi)
...
# REMOVED: kmod-siit, kmod-sit (IPv6)
...
# REMOVED: kmod-usb-net-aqc111, kmod-usb-net-asix, kmod-usb-net-asix-ax88179 (网络适配器，如果不需要可移除)
PACKAGES="$PACKAGES kmod-usb-net-cdc-eem"
PACKAGES="$PACKAGES kmod-usb-net-cdc-ether"
# REMOVED: kmod-usb-net-cdc-mbim, kmod-usb-net-cdc-ncm, kmod-usb-net-qmi-wwan, kmod-usb-net-hso, kmod-usb-net-huawei-cdc-ncm, kmod-usb-net-sierrawireless (WWAN)
...
# REMOVED: kmod-usb-serial-wwan (WWAN)
...
# REMOVED: luci-app-dockerman (Docker)
...
# REMOVED: luci-i18n-dockerman-zh-cn (Docker)
...
# REMOVED: luci-lib-docker (Docker)
...
# REMOVED: luci-proto-ipv6 (IPv6)
# REMOVED: luci-proto-mbim, luci-proto-modemmanager, luci-proto-ncm, luci-proto-qmi (WWAN)
...
# REMOVED: modemmanager, umbim, uqmi (WWAN)
PACKAGES="$PACKAGES mount-utils"
PACKAGES="$PACKAGES mtd"
# REMOVED: mwifiex-pcie-firmware (WiFi)
...
# REMOVED: odhcp6c, odhcpd-ipv6only (IPv6)
...
# REMOVED: rtl8192*, rtl8723*, rtl88*, rtl89* (WiFi/无线固件)
# REMOVED: runc (Docker)
...
# REMOVED: ucode-mod-nl80211 (WiFi)
...
# REMOVED: umbim, unet-cli, unetd, uqmi (WWAN)
...
# REMOVED: wifi-scripts, wireless-regdb, wpa-cli, wpa-supplicant-openssl (WiFi)
